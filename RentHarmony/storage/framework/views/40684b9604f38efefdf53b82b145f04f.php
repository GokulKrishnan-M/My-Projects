                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="<?php echo e(asset('/uploads/' . $instruments->image)); ?>" width="700" style="height:630px;"/> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                           
                                <h5 class="text-uppercase"><?php echo e($instruments->instname); ?></h5>
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price">₹<?php echo e($instruments->ppd); ?></span>
                                    
                                </div>
                            </div>
                            <p class="about"><?php echo e($instruments->desc); ?></p>
                             <p class="about">stock:<?php echo e($instruments->stock); ?></p>
                            <div class="cart mt-4 align-items-center"> <a href="<?php echo e(route('booking' , ['instid' => $instruments->instid])); ?>" class="btn btn-danger text-uppercase mr-2 px-4"> BOOK NOW</a> </div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.customermaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravelprojects\RentHarmony\resources\views/Customer/instsingleview.blade.php ENDPATH**/ ?>