...
<div class="hero" style="background-image: url(<?php echo e(asset('guest/images/hero_1_a.jpg')); ?>); ">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2">
              <div class="img-wrap-1 mb-5">
                <img src="<?php echo e(asset('guest/images/feature_01 (2).png')); ?>" alt="Image" class="img-fluid">
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_6.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_5.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Nissan Moco</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_4.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Honda Fitta</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_3.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Skoda Laura</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_2.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Mazda LaPuta</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="<?php echo e(asset('guest/images/car_1.jpg')); ?>" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('guest/images/person_1.jpg')); ?>" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('guest/images/person_2.jpg')); ?>" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo e(asset('guest/images/person_3.jpg')); ?>" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
...
<?php echo $__env->make('layouts.guestmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravelprojects\RentHarmony\resources\views/Guest/guesthome.blade.php ENDPATH**/ ?>