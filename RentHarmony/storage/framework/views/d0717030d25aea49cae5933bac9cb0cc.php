...
<div class="content">
  <form action="adminloginp" method="post">
    <?php echo csrf_field(); ?>
    <h2>Login</h2>
    <div class="input-box">
    ...
    <div class="input-box">
      <input type="password" id="password" placeholder="Password" required autocomplete="new-password" name="password"/>
...
</div><?php /**PATH C:\Laravelprojects\RentHarmony\resources\views/Guest/adminlogin.blade.php ENDPATH**/ ?>