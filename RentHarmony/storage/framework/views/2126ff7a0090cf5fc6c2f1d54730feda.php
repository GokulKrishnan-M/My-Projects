  ...
  <div class="row g-4 justify-content-center">
    ...
    <div class="col-md-6">
      <div class="card booking-card p-3">
        ...
        <div class="card-body">
          <h5 class="card-title text-center"><?php echo e($products->productname); ?></h5>
          <form action="<?php echo e(route('booking_payment_insert')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <p class="text-muted text-center mb-2">
              <strong>Price per day:</strong> ₹<?php echo e($products->ppd); ?>
            ...
            <input type="hidden" id="price_per_day_value" value="<?php echo e($products->ppd); ?>">
            <input type="hidden" id="productid" name="instid" value="<?php echo e($products->instid); ?>">
            ...
            <div class="form-group mb-8" style="margin-left:30px;">
              ...
              <input type="number" name="quantity" class="form-control" id="quantity" min="1" max="<?php echo e($products->stock); ?>" value="1" required>
            </div>
...
<?php echo $__env->make('Layouts.CustomerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravelprojects\RentHarmony\resources\views/Customer/booking.blade.php ENDPATH**/ ?>