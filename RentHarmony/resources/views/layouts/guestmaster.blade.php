...
<html lang="en">
  ...
  <body>
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation" >
                <ul class="site-menu main-menu js-clone-nav ml-auto " >
                  <li class="active"><a href="{{route('guestview')}}" class="nav-link" style="color:white;">Home</a></li>
                  <li class="active"><a href="{{route('customer')}}" class="nav-link" style="color:white;">Register</a></li>
                  <li class="active"><a href="{{route('customerlogin')}}" class="nav-link" style="color:white;">Login</a></li>
                </ul>
              </nav>
            </div>
    ...
    <script src="{{asset('guest/js/bootstrap-datepicker.min.js')}}"></script>
