...
<div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{route('update_subcat',$subcat->subcatid)}}" method="post" enctype="multipart/form-data">
                     @csrf
                    <div class="form-group">
                      <label for="exampleInputName1"> Subcategory Name</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="subcategoryname" value="{{ $subcat->subcatname }}">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputName1"> Image</label>
                      <img src="{{ asset('/uploads/' . $subcat->subimage) }}" class="h-20 w-20 object-cover rounded shadow" alt="Image" 
 style="height: 100px;width:100px;">
                    </div>
                    <input type="hidden" class="form-control" id="exampleInputName1" placeholder="Name" name="oldimage" value="{{ $subcat->subimage }}">
