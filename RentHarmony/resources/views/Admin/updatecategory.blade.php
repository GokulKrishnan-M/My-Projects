...
<div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form  class="forms-sample"form  action="{{route('update_cat',$cat->catid)}}" method="post" enctype="multipart/form-data">
                     @csrf
                    <div class="form-group">
                      <label for="exampleInputName1"> District Name</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="categoryname" value="{{ $cat->catname }}">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputName1"> Image</label>
                      <img src="{{ asset('/uploads/' . $cat->image) }}" class="h-20 w-20 object-cover rounded shadow" alt="Image" 
 style="height: 100px;width:100px;">
                    </div>
                    <input type="hidden" class="form-control" id="exampleInputName1" placeholder="Name" name="oldimage" value="{{ $cat->image }}">
